...
if ERRORLEVEL 1 (
  ...
  pandoc  --metadata title="%CurrDirName%" -V title="" --standalone --columns 2000 -f gfm -t html --embed-resources -c https://raw.githubusercontent.com/JackieWaltRyan/github.css/refs/heads/main/github-pandoc.css -o .\out\%CurrDirName%\README.html README.md
)
:zip
